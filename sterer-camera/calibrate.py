...
for i in tqdm(range(1,28)):
    ...
    retR, cornersR =  cv2.findChessboardCorners(outputR,(5,7),None)
    retL, cornersL = cv2.findChessboardCorners(outputL,(5,7),None)

    if retR and retL:
        obj_pts.append(objp)
        cv2.cornerSubPix(imgR_gray,cornersR,(11,11),(-1,-1),criteria)
        cv2.cornerSubPix(imgL_gray,cornersL,(11,11),(-1,-1),criteria)
        cv2.drawChessboardCorners(outputR,(5,7),cornersR,retR)
        cv2.drawChessboardCorners(outputL,(5,7),cornersL,retL)
